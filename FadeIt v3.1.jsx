    ...
    function fadit_createPalette(thisObj) {
        ...
        with(palette){
            ...
            with(palette.H){
                ...
                palette.H.famount = add('edittext', undefined, '100');
                palette.H.famount.preferredSize = [40,20];
                palette.H.inout = add('dropdownlist',[10,10,80,30],['In and Out', 'In only', 'Out only']);
